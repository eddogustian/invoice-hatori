                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <table>
                                    ...
                                    <tr>
                                        <td>Alamat</td>
                                        <td>:</td>
                                        <td>Perumahan Taman Pengampon</td>
                                    </tr>
                                    <tr>
                                        <td>No Telp</td>
                                        <td>:</td>
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>     <!-- MENAMPILKAN PRODUK YANG TELAH DITAMBAHKAN -->
                                        @php $no = 1 @endphp
                                    ...
                                    <tfoot><!-- FORM UNTUK MEMILIH PRODUK YANG AKAN DITAMBAHKAN -->
                                        <tr>
                                            <td></td>
                                            <td>
                                            ...
                                            <td><input type="number" min="1" value="1" name="qty" class="form-control" required></td>
                                            <td colspan="3">
